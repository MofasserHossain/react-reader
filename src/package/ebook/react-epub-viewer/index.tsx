...
// utils
import { debounce, timeFormatter } from '../lib/utils'
// styles
import viewerDefaultStyles from './style'
// types
import { ReactViewerProps, ViewerRef } from '@/types/epub'
import BookType, { BookOption, BookStyle } from '@/types/epub/book'
...
const ReactViewer = (
  ...
  useEffect(() => {
    if (!book) return
    Promise.all([book.loaded.metadata, book.opened, book?.loaded?.spine])
